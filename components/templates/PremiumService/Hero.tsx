      ...
      <div className="container mx-auto px-4 z-10">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
            Professional HVAC Solutions For Your <span className="text-blue-400">Comfort</span> & <span className="text-blue-400">Peace of Mind</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4">
            <a 
              href="#contact" 
              className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-md font-medium text-lg transition-colors inline-block"
            >
              Get Free Estimate
            </a>
            ...
            {company.phone && (
              <a 
                ...
                className="bg-transparent border-2 border-white/50 hover:border-white text-white px-8 py-4 rounded-md font-medium text-lg transition-colors inline-block flex items-center"
              >
