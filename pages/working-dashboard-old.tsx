              ...
              <div key={company.id} className="bg-white rounded-lg shadow-sm border overflow-hidden">
                ...
                >
                    ...
                    {(company as any).rating && (
                      <div className="text-right">
                        <div className="flex items-center gap-1">
                          ...
                          <span className="font-medium">{(company as any).rating}</span>
                          <span className="text-gray-500 text-sm">({(company as any).review_count || 0})</span>
                        </div>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-3">
                    ...
                    {(company as any).reviews_link && (
                      <a 
                        href={(company as any).reviews_link}
                        target="_blank"
                        rel="noopener noreferrer"
