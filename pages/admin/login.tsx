...
export default function AdminLogin() {
  ...
  useEffect(() => {
    ...
    if (urlError) {
      switch (urlError) {
        case 'access_denied':
          setError('Access denied. Only Nicholas and Jared have admin access.');
          break;
        case 'auth_failed':
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20">
          <div className="text-center">
            ...
            <button
              ...
              disabled={loading}
              className="w-full bg-white text-gray-900 font-semibold py-3 px-6 rounded-lg hover:bg-gray-100 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-3"
            >
              {loading ? (
