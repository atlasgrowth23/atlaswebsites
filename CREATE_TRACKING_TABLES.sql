...
-- This will create all the tracking tables needed for your analytics system
...
DROP TRIGGER IF EXISTS update_template_views_updated_at ON template_views;
...
-- Show the test record was created
SELECT 
  id, 
  company_slug, 
  session_id, 
  ...
  created_at 
FROM template_views 
WHERE company_id = 'test-setup-123' 
